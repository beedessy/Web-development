...
<body>
    <!--header-->
    <header style="background-color:#1F4786;">
        <div class="container" >
            <div class="row">
  ...
  <br>
  <br>
  <h1 style="text-align:center" > Blushes Products </h2>
  <br>

<div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM faceproduct where id BETWEEN 1 and 8");
   $stmt->execute();
          ...
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" style="background-color:#204B72  "><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Add to
                  cart</button>
              </form>
            </div>
          </div>
...
<br>
<br>
<h1 style="text-align:center" > Concealers Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM faceproduct where id BETWEEN 9 and 16");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
 ...
 <br>
 <br>
 <h1 style="text-align:center" > Foundations Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM faceproduct where id BETWEEN 17 and 24");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
 ...
 <br>
<br>
<h1 style="text-align:center" > Powders Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM faceproduct where id BETWEEN 25 and 32");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
...
<br>
<br>
<h1 style="text-align:center" > Primers Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM faceproduct where id BETWEEN 33 and 40");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
    ...
    <!--/Main Section-->
    <footer>
       <div class="footer-area footer-padding" style="background-color:#B9D1F9;">
            <div class="container">
