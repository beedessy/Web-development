...
<body>
    <!--header-->
    <header style="background-color:#b30059;">
        <div class="container">
            <div class="row">
  ...
  <source src="Assets\Brushvideo.mp4" type="video/mp4">
  </video>
  <br>
  <br>
  <h1 style="text-align:center" > Makeup Brushes Products </h2>
  <br>

<div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM makeupbrushproduct where id BETWEEN 1 and 8");
   $stmt->execute();
   ...
   ?>
          ...
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" style="background-color:#b30059"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Add to
                  cart</button>
              </form>
            </div>
          </div>
    ...
    <!--/Main Section-->
      ...
      <footer>
       <div class="footer-area footer-padding"  style="background-color:#ffb3d9;">
            <div class="container">
