...
<body>
    <!--header-->
    <header style="background-color:#ff6c52;">
        <div class="container">
            <div class="row">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active"  role="listbox">
      <img class="d-block h-2000 w-100" src="Assets\Flashsales1.JPG" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block h-2000 w-100" src="Assets\FlashSales2.gif" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block h-2000 w-100" src="Assets\FlashSales3.gif" alt="Third slide">
    </div>
  </div>
...
<div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM flashsales where id BETWEEN 1 and 8");
   $stmt->execute();
   ...
   ?>
          ...
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" style="background-color:#FF6347"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Add to
                  cart</button>
              </form>
            </div>
          </div>
    ...
    <!--/Main Section-->
    <footer>
       <div class="footer-area footer-padding" style="background-color:#fc9886;">
            <div class="container">
