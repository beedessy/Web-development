...
<body>
    <!--header-->
    <header style="background-color:#48D1CC;">
        <div class="container">
            <div class="row">
  ...
  <source src="Eyesvideo.mp4" type="video/mp4">
  </video>
  <br>
  <br>
  <h1 style="text-align:center" > Eyeshadows Products </h2>
  <br>

<div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM eyeproduct where id BETWEEN 1 and 8");
   $stmt->execute();
          ...
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" style="background-color:#008B8B"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Add to
                  cart</button>
              </form>
            </div>
          </div>
...
<br>
<br>
<h1 style="text-align:center" > Eyeliners Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM eyeproduct where id BETWEEN 9 and 16");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
 ...
 <br>
 <br>
 <h1 style="text-align:center" > Mascaras Products </h2>
  <br>
 ...
 <div class="container">
  ...
  <div class="row">
   <?php
   include 'config.php';
   $stmt = $conn->prepare("SELECT * FROM eyeproduct where id BETWEEN 17 and 24");
   $stmt->execute();
   $result=$stmt->get_result();
   while($row =$result->fetch_assoc()):
   ?>
 ...
 <br>
    ...
    <!--/Main Section-->
    <footer>
       <div class="footer-area footer-padding"     style="background-color:#AFEEEE;">
            <div class="container">
